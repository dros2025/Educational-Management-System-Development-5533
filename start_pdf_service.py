...
if __name__ == '__main__':
    print("🚀 Starting PDF Generator Service...")
    print("📄 Service will be available at: http://localhost:5000")
    print("✅ Ready to generate professional lesson PDFs!")
    print("🌐 CORS enabled for frontend communication")
    print("\n🔗 Endpoints:")
    print("   GET  /health - Check service status")
    print("   POST /generate-lesson-pdf - Generate single lesson PDF")
    print("   POST /generate-batch-pdf - Generate multiple lessons PDF")
    print("\n💡 The AI Lesson Bot will automatically detect this service!")
